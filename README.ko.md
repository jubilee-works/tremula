...
>
> **사내 코드를 제공자에게 보낼지는 사용하는 쪽의 판단입니다.** 조직 소유의
> 코드에 tremula를 돌리기 전에 조직의 정책과 제공자의 데이터 사용 약관을
> 확인하세요 — 보관 기간, API 입력의 학습 사용 여부, 처리 리전은 제공자와
> 플랜마다 다릅니다. tremula는 위에서 설명한 내용만, API 키가 가리키는
> 제공자에게만 전송합니다.
>
