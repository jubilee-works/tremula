...
file in the bundle except `bundle.json` and `START_HERE.md`, which are what describe the
rest. Each hash is checked against the bytes on disk before the bundle is published.
Every patch was offered to
